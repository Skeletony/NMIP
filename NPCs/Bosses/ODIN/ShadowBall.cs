	...
	public class ShadowBall : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			...
			if (npc.life <= 0)
			{
				...
				{
					int num622 = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y), npc.width, npc.height, 111, 0f, 0f, 100, default(Color), 0.5f);
				...
				{
					int num624 = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y), npc.width, npc.height, 111, 0f, 0f, 100, default(Color), 1.5f);
					Main.dust[num624].noGravity = true;
					Main.dust[num624].velocity *= 2f;
					num624 = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y), npc.width, npc.height, 111, 0f, 0f, 100, default(Color), 1f);
		...
		public override bool CheckDead()
		{
			...
			{
				int num384 = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y), npc.width, npc.height, 111, 0f, 0f, 0, default(Color), 1f);
