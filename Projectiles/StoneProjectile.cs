...
namespace NMIP.Projectiles
{
    public class StoneProjectile : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Fusion Blade");     //The English name of the projectile
        }
        ...
        {
            spriteBatch.Draw(mod.GetTexture("Projectiles/StoneProjectile"), new Vector2(projectile.Center.X - Main.screenPosition.X, projectile.Center.Y - Main.screenPosition.Y),
            ...
            spriteBatch.Draw(mod.GetTexture("Projectiles/StoneProjectile_Glow"), new Vector2(projectile.Center.X - Main.screenPosition.X, projectile.Center.Y - Main.screenPosition.Y),
        ...
        public override void AI()
        {
            ...
            {
                int dustnumber = Dust.NewDust(projectile.position, projectile.width, projectile.height, 73, 0f, 0f, 211, default(Color), 0f);
